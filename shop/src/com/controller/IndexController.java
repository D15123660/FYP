...
/**
 * Front-end related interface
 */
@Controller
@RequestMapping("/index")
public class IndexController{
	
	private static final int rows = 8; // Default number per page
	...
	public String index(HttpServletRequest request){
		...
		for(Types type : typeList) {
			...
			map.put("type", type);
			map.put("goodList", goodService.getListByType(type.getId(), 1, 8)); // Take the first 8
			dataList.add(map);
		}
