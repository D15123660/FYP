		...
		<section class="user-center inner clearfix">
			<div class="user-content__box clearfix bgf">
				...
				<form action="pay" method="post" class="shopcart-form__box">
					...
					<div class="shop-title">Shipping address</div>
					<div class="addr-radio user-addr__form form-horizontal">
						<div class="form-group">
							<label for="name" class="col-sm-2 control-label">Name：</label>
							<div class="col-sm-6">
								<input class="form-control" name="name" value="${sessionScope.user.name}" placeholder="Please enter your name" type="text" required="required">
							</div>
						</div>
						<div class="form-group">
							<label for="name" class="col-sm-2 control-label">Phone：</label>
							<div class="col-sm-6">
								<input class="form-control" name="phone" value="${sessionScope.user.phone}" placeholder="Please enter your phone number" type="text" required="required">
							</div>
						</div>
						<div class="form-group">
							<label for="name" class="col-sm-2 control-label">Address：</label>
							<div class="col-sm-6">
								<input class="form-control" name="address" value="${sessionScope.user.address}" placeholder="Please enter your address" type="text" required="required">
							</div>
						</div>
					</div>
					
					<div class="shop-title">Rrder details</div>
					<div class="shop-order__detail">
						<table class="table">
							<thead>
								<tr>
									<th width="150">Product cover</th>
					...
					<div class="shop-title">Payment method</div>
