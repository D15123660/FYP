;(function ($, window, document, undefined) {
  ...
  Magnifier.prototype = {
    moveBigPic: function () { // Change the big picture
    ...
    changeSrouce: function (index, big_src, sml_src) { // Change the size of the map address
      this.$smallBox_pic.attr('src', sml_src);
      this.$bigBox_pic.attr('src', big_src);
    },

    setMask: function () { // Set the width and height of the mask
    ...
    inital: function () { // initialization
      var self = this;
